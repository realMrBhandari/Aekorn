...
connect = sqlite3.connect("transactions/aekorn.db")
...
cursor.execute(
    """CREATE TABLE obligations (
            ...
            obligation_status TEXT NOT NULL CHECK(obligation_status IN ('ACTIVE', 'CLOSED')),
            closure_date TEXT CHECK(closure_date IS NULL OR closure_date > obligation_date),
